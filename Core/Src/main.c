...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, LED_GREEN_Pin|BUTTON_OUT_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LED_2_Pin|LED_3_Pin|POT_OUT_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LED_2_Pin LED_3_Pin POT_OUT_Pin */
  GPIO_InitStruct.Pin = LED_2_Pin|LED_3_Pin|POT_OUT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
